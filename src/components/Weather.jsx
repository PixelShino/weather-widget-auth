...
// API ключи
const WEATHER_KEY = '1b5b6c9ae6d14334be272534250205';

export default function Weather({ onLogout }) {
  const [city, setCity] = useState('Moscow'); // Default to Moscow as per requirements
  ...
  async function fetchWeatherData(query) {
    ...
    try {
      ...
      const res = await fetch(
        `https://api.weatherapi.com/v1/forecast.json?key=${WEATHER_KEY}&q=${query}&days=3&aqi=yes&alerts=yes`,
      );
